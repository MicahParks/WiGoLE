...
// Body builds the request body reader for an API call to stats/user.
func (p *Parameters) Body() (io.Reader, error) {
	return nil, nil
}

// Url builds the URL values for an API call to stats/user.
func (p *Parameters) Url() (values url.Values, err error) {
	return url.Values{}, nil
}

// Do wraps the API call for stats/user.
...
// New initializes and returns a pointer to parameters that can be used to make an API call to stats/user.
func New() *Parameters {
	return &Parameters{}
}
